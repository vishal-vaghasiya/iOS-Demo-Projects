...
@objc public protocol SwiftyKeyboardDelegate : AnyObject {
    ...
    /// Notifies the delegate when the Save button is pressed.
    ///
    /// - Parameter numberKeyboard: The keyboard whose Save button was pressed.
    @objc optional func numberKeyboardDidPressSave(_ numberKeyboard: SwiftyKeyboard)
}
