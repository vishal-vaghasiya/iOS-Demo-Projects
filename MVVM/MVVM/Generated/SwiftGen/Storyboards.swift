...
internal enum StoryboardScene {
  internal enum Login: StoryboardType {
    ...
    internal static let initialScene = InitialSceneType<MVVM.LoginViewController>(storyboard: Login.self)

    internal static let loginViewController = SceneType<MVVM.LoginViewController>(storyboard: Login.self, identifier: "LoginViewController")
  }
}
