...
extension ViewController: CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        if shouldTriggerPINUpdate(newLocation: newLocation) {
            createMarker(titleMarker: "My Location", iconMarker: UIImage(named: "pin")!, latitude: newLocation.coordinate.latitude, longitude: newLocation.coordinate.longitude)
        }
    ...
    func shouldTriggerPINUpdate(newLocation: CLLocation) -> Bool {
        // Compare current and previous locations' latitude and longitude
        if let previousLocation = previousLocation {
            return newLocation.coordinate.latitude != previousLocation.coordinate.latitude ||
            newLocation.coordinate.longitude != previousLocation.coordinate.longitude
        }
        return false // Initial case, no previous location
    }
}
